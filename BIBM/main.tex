...
Therefore scSpark can automatically parallel process on each node with same volume of data.
...
To identify whether scSpark can get better performance than three tradition pipelines, we 
