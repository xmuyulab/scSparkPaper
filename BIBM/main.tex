...
Then all the SAM RDDs and GTF RDDs were grouped by chromosome into Grouped SAM RDDs and Grouped GTF RDDs respectively for parallel processing, and the gene name could be assigned to each aligned read using \textit{join} function.
