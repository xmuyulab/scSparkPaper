...
ScSpark was designed on the top of the Spark framework.
...
% 参考：We design our engine on top of the Spark framework, which by default keeps persistent RDDs in memory. 
Therefore scSpark inherently take advantage of Spark's trait including distribute compute and default keeps persistent RDDs in memory.
ScSpark's algorithm refers to UMI\-tools, including barcode extraction, sequence quality control, genome alignment and transcipt counting.
